...
func (m *VO) Bind(tp string, raw *gjson.Result, mo *gotext.Mo, po *gotext.Po) {
	// common bind
	...
	m.ModName = i18n.TranString(m.ModName, mo)
...
func (m *VO) bindMonster(raw *gjson.Result, mo *gotext.Mo) {
